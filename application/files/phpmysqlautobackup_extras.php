...
function xmail ($to_emailaddress,$from_emailaddress, $subject, $content, $file_name, $backup_type, $newline)
{
 $mail_attached = "";
...
{
 $fp = fopen(APPLICATION_PATH."data/backups/".$backup_file_name, "w");
 fwrite($fp, $gzdata);
 fclose($fp);
